...
>
> **标的状态更新**：最新标的决策见 `token_selection_framework.md`，多标的组合分析见 `archive/multi_asset_combination_analysis.md`（2026-05-22 更新）。
...
**待停止原因（LINK/ARB/LDO）：** 详见 `token_selection_framework.md`。
