...
| 2026Q2 | 1.14 | 4月低点（0.52–1.29），5月已回升（1.61–2.13），未触发审查条件 |

**2026Q2 诊断结论（2026-06-10）：** 4月系统性低点，全部策略同期破预警线，归因为横盘磨损，非策略失效。5月全面回升，未触发"连续2个月 < 1.58"审查条件。BTC_ema 连续3月（2–4月）低于预警线，整体诊断已覆盖，结论相同。

## 各标的回撤情况（数据截至 2026-05-13，已过时）
