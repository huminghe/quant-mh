...
> ⚠️ 数据截至 2026-05-13，已过时。用 `run_all.py` 重新生成最新数据。
> LINK/ARB/LDO 已于 2026-06-10 全部停止运行，不再纳入监控。
...
| ~~LINK~~ | 2025-08-12 | 34,031 | 23,588 | -10,443 | -52.2% | **已停止（2026-06-10）** |
| ~~ARB~~ | 2025-08-11 | 24,538 | 14,372 | -10,166 | -50.8% | **已停止（2026-06-10）** |
| ~~LDO~~ | 2025-09-01 | 24,962 | 13,626 | -11,336 | -56.7% | **已停止（2026-06-10）** |

**停止原因（LINK/ARB/LDO）：** 详见 `docs/archive/stop_decision_link_arb_ldo.md`。
